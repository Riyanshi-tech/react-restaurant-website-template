              ...
              <Route element={<ProtectedRoute />}>
                <Route element={<DashboardLayout />}>
                  ...
                  <Route element={<ProtectedRoute allowedRoles={["ADMIN"]} />}>
                    ...
                    <Route path="/dashboard/admin/users" element={<div className="p-4 bg-forest-900/40 rounded-2xl border border-gold-300/10">User Management Dashboard (Phase 3)</div>} />
                  ...
                  <Route element={<ProtectedRoute allowedRoles={["MANAGER"]} />}>
                    ...
                    <Route path="/dashboard/manager/logs" element={<div className="p-4 bg-forest-900/40 rounded-2xl border border-gold-300/10">Operations Activity Log (Phase 4)</div>} />
                  </Route>
